...
echo'<th>Identifiant Effectuer</th><th>Matricule Eleve</th><th>Identifiant Paiement</th><th>Date Effectuée</th>';
echo'</tr>';
//Traitement de données
while($row=mysql_fetch_array($resultat)){
    echo'<tr>';
    echo'<td>'.$row['IdEffectuer'].'</td>';
    echo'<td>'.$row['MatriculeEleve'].'</td>';
    echo'<td>'.$row['IdPaiement'].'</td>';
    echo'<td>'.$row['DateEffectuer'].'</td>';
    echo'</tr>';
}
