...
echo'<table bgcolor="#fff" border="2" align="center" width="70%">';
echo'<tr>';//Debut de la ligne
echo'<th>Identifiant Paiement</th><th>Montant Paiement</th><th>Motif Paiement</th>';
echo'</tr>';
//Traitement de données
while($row=mysql_fetch_array($resultat)){
    echo'<tr>';
    echo'<td>'.$row['IdPaiement'].'</td>';
    echo'<td>'.$row['MontantPaiement'].'</td>';
    echo'<td>'.$row['MotifPaiement'].'</td>';
    echo'</tr>';
}
